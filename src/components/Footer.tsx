...
const COPY = {
  ...
  heading: 'Você não precisa continuar carregando',
  headingEm: 'esse peso sozinha.',
  subtitle: 'A primeira sessão é gratuita, online e sem compromisso. É só uma conversa para você sentir como é o meu trabalho.',
  ctaText: 'Quero agendar minha sessão gratuita agora',
}
// ════════════════════════════════════════════════════════════════════
