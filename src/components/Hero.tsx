...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'CONGELAMENTO EMOCIONAL',
  h1: 'A vida parou. Você sente, mas',
  h1Em: 'não consegue reagir.',
  subtitle: 'Carregar essa paralisia por anos cansa mais do que qualquer trabalho. Existe um caminho para sair do gelo.',
