...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Uma mensagem',
  headingEm: 'para você.',
  preText: 'Eu sei o que é viver assim. Passei 25 anos congelada por dentro depois de perder meu primeiro filho. E sei o quanto cansa fingir que está tudo bem.',
  postText: 'Assista ao vídeo. Nele eu conto como é possível sair desse lugar sem precisar reviver o que dói.',
}
// ════════════════════════════════════════════════════════════════════
